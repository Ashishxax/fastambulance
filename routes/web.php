...
Route::middleware('auth')->group(function(){
    ...
    Route::get('user','Admin\DashboardController@admin_users')->name('admin.users');
    Route::get('ambulance','Admin\DashboardController@ambulance')->name('admin.ambulance');
    Route::get('booking-request','Admin\RequestController@booking_request')->name('admin.request');
    Route::get('user-search','Admin\RequestController@user_search')->name('admin.search');
